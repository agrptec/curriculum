...
#let name = "cv-phd"
#let locale-catalog-page-numbering-style = context { "cv-phd - Page " + str(here().page()) + " of " + str(counter(page).final().first()) + "" }
...
#three-col-entry(
  ...
  middle-content: [
    #strong[Stanford University], Computer Science -- Stanford, CA, USA
  ],
  right-content: [
    Sept 2023 – present
  ],
...
#three-col-entry(
  ...
  middle-content: [
    #strong[Boğaziçi University], Computer Engineering -- Istanbul, Türkiye
  ],
  right-content: [
    Sept 2018 – June 2022
  ],
